...
if (isDev) {
  // webpack hot page reloading for dev
  app.use(
...
app.use(function (err, req, res, next) {
  ...
  req.flash('error', 'Forbidden, reload the page and try again')
  logger.warn('403 ' + err)
  res.redirect('back')
})
...
app.use((err, req, res, next) => {
  ...
  if (!isDev) {
    ...
    // render error page in dev mode with err.stack
