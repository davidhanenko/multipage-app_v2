...
module.exports = {
  entry: {
    ...
    about: isDev
      ...
      : './public/js/about.js',
    post: isDev
      ? ['webpack-hot-middleware/client?reload=true', './public/js/post.js']
      : './public/js/post.js',
    admin: isDev
      ? [
  ...
  plugins: [
    ...
    // about
    new HtmlWebPackPlugin({
      template: '!!ejs-webpack-loader!./public/views/blog/post.ejs',
      filename: 'views/blog/post.ejs',
      chunks: isDev ? ['post'] : ['post', 'manifest', 'vendors']
    }),

    //ADMIN
    // admin-price-new
    new HtmlWebPackPlugin({
      template: '!!ejs-webpack-loader!./public/views/admin/blog/post-new.ejs',
      filename: 'views/admin/blog/post-new.ejs',
      chunks: isDev ? ['admin_blog'] : ['admin_blog', 'manifest', 'vendors']
    }),
    new HtmlWebPackPlugin({
      template:
    ...
    new HtmlWebPackPlugin({
      template:
        '!!ejs-webpack-loader!./public/views/admin/admin-page/admin.ejs',
      filename: 'views/admin/admin-page/admin.ejs',
    ...
    new HtmlWebPackPlugin({
      template: '!!ejs-webpack-loader!./public/views/admin/blog/post.ejs',
      filename: 'views/admin/blog/post.ejs',
      chunks: isDev ? ['admin_blog'] : ['admin_blog', 'manifest', 'vendors']
    }),
    new HtmlWebPackPlugin({
      template:
