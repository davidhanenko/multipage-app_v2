...
const postCreatedAtFormat = require('../../utils/postDate')
...
module.exports.register = async (req, res) => {
  ...
  if (!errors.isEmpty()) {
    ...
    try {
      ...
      // add error to the logger and reveal on page throw alert
...
// signin logic
// ============ LIMITER
// use our db connection to count and save incorrect password inputs
...
module.exports.displayContent = async (req, res) => {
  try {
    // check admin permission password to change view mode
